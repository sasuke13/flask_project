    ...
    def app_context():
        with app.app_context():
            ...
            harry_potter_and_deathly_hallows_1 = Film(
                ...
                description='As Harry (Daniel Radcliffe), Ron (Rupert Grint), and Hermione (Emma Watson) race against time and evil to destroy the Horcruxes, they uncover the existence of the three most powerful objects in the wizarding world: the Deathly Hallows.',
                distributed_by='Warner Bros. Pictures',
                length=146,
                rating=7.7,
            )
            ...
            daniel_radcliffe = Actor(name='Daniel Radcliffe', birthday=date(1989, 7, 23), isactive=True)
            emma_watson = Actor(name='Emma Watson', birthday=date(1990, 4, 15), isactive=True)
            rupert_grint = Actor(name='Rupert Grint', birthday=date(1988, 9, 24), isactive=True)
            richard_harris = Actor(name='Richard Harris', birthday=date(1930, 10, 1), isactive=False)
            michael_gambon = Actor(name='Michael Gambon', birthday=date(1940, 10, 19), isactive=True)
            alan_rickman = Actor(name='Alan Rickman', birthday=date(1946, 2, 21), isactive=False)

            harry_potter_and_ph_stone.actors = [daniel_radcliffe, emma_watson, rupert_grint, richard_harris,
                                                alan_rickman]
            harry_potter_and_ch_s.actors = [daniel_radcliffe, emma_watson, rupert_grint, richard_harris, alan_rickman]
            harry_potter_and_priz_az.actors = [daniel_radcliffe, emma_watson, rupert_grint, michael_gambon,
                                               alan_rickman]
